...
# 修改重點: 
#   1. 修正 Google GenAI SDK 呼叫語法（client.models.generate_content）
#   2. 徹底解決 'Client' object has no attribute 'generate_content' 錯誤
#   3. 完善 Gemini 2.0-flash / 1.5-flash 自動模型備援機制
# ====================================================
...
### 💡 更新操作小建議：
請點擊程式碼區塊右上角的 **「Copy」** 圖示進行全選複製，接著至 GitHub 打開 `app.py`，全選刪除舊內容後貼上。這樣能避免手動框選複製時誤抓到區塊外的中文文字。# ====================================================
# 台股價值與潛力股智慧分析系統 (Taiwan Stock Screener)
# 版本別 (Version): v1.1.5
# 更新日期 (Date): 2026-08-12
# 修改重點: 
